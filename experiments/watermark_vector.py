...
logging.basicConfig(
    filename='/remote-home/miintern1/watermark-learnability/logs/watermark_vector.txt',  # Specify the log file name
...
num_samples = 500
batch_size = 16
save_path = '/remote-home/miintern1/watermark-learnability/data/c4/watermark_vector.json'
...
# Set how many samples will be skipped, used when resuming from a previous run
...
for watermark_name, watermark_config in watermark_config.items():
    ...
    coefficient_list = np.arange(0, 1.01, 0.2)
    ...
    for coefficient in coefficient_list:
        ...
        all_model_dict[watermark_name][coefficient]["watermarked_output"] = watermarked_output_results
