    ...
    def detect(
        ...
        **kwargs,
        ...
        if text and text.strip() == "":
            print(f"Skipping text because it is empty or only whitespace: '{text}'")
            return {}
        if tokenized_text is None:
            ...
            try:
                ...
                if tokenized_text.size(0) == 0:
                    print(f"Original text:\n{text}")
                    print(f"Tokenized text:\n{tokenized_text}")
                    raise ValueError("Tokenized text is empty after tokenization.")
